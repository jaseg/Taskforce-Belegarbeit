...
Der bisherige Stand der Webanwendung (die im übrigen mangels besserer Vorschläge den Namen \emph{Taskforce} trägt) ist, dass diese wiewohl noch nicht für den Alltagsgebrauch geeignet doch schon die Hauptfunktionalität besitzt. Der aktuelle Quelltext ist auf Github unter \url{http://github.com/jaseg/Taskforce} verfügbar.
